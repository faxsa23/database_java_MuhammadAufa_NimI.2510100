...
public class FormKaryawan extends JFrame {
    ...
    private void fillTable(boolean filter) {
        ...
        if (rs == null) {
            JOptionPane.showMessageDialog(this, "Gagal memuat data. Pastikan database aktif dan pengaturan koneksi benar.");
    ...
    private void insertData() {
        ...
        if (ck.insert()) {
            ...
            JOptionPane.showMessageDialog(this, "Gagal menyimpan data. Pastikan koneksi database aktif.");
        }
    }
    ...
    private void updateData() {
        ...
        if (ck.update()) {
            ...
            JOptionPane.showMessageDialog(this, "Gagal mengupdate data. Pastikan koneksi database aktif.");
        }
    }
    ...
    private void deleteData() {
        ...
        if (answer == JOptionPane.YES_OPTION) {
            ...
            if (ck.delete()) {
                ...
                JOptionPane.showMessageDialog(this, "Gagal menghapus data. Pastikan koneksi database aktif.");
            }
        }
    }
    ...
    private void searchByNip() {
        ...
        if (rs == null) {
            JOptionPane.showMessageDialog(this, "Gagal mencari data. Pastikan database aktif dan pengaturan koneksi benar.");
            return;
        }
